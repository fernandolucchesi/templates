...
export default function TemplateTwo() {
  return (
    <>
      <header className="flex flex-wrap items-center w-full px-6 py-2 bg-white lg:h-16 lg:px-16 lg:py-0 lg:flex-nowrap lg:relative">
        <div className="flex items-center justify-between flex-1 h-full lg:flex-none lg:absolute">
        ...
        <div
          className="hidden w-full lg:flex lg:items-center lg:justify-center"
          id="menu"
        >
          <nav>
            <ul className="items-center justify-between pt-4 lg:flex lg:pt-0">
              {[...Array(6)].map((_, key) => (
                <li key={key}>
                  <a
                    className="block px-0 py-3 lg:p-4 lg:px-5 hover:text-gray-500"
      ...
      <section className="bg-center bg-cover bg-hero-image">
        <div className="flex flex-row ">
          <div className="flex-col w-full p-4 my-24 text-center center-x center-y">
